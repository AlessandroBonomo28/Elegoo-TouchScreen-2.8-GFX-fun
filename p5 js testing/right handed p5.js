...
cosa ho dovuto fare per convertire da left handed a right handed:

1) yDir = -1
2) moltiplicare per -1 l'angolo nelle funzioni di rotazione.
3) modificato il refbaseForward della telecamera
    (pensa che il forward sia 0,0,-1)
    ho dovuto anche invertire il pitch dell'updateLook
*/
...
function updateLook() {
  ...
  vDirLook =  multiplyVectorMatrix(camRefForward,
